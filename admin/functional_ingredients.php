                                                ...
                                                <div class="custom-tab">
                                                    ...
                                                    <nav>
                                                        <div class="nav nav-pills nav-justified mb-3" id="pills-tab" role="tablist">
                                                            ...
                                                            <a class="nav-item nav-link" id="custom-nav-contact-tab" data-toggle="tab" href="#point5" role="tab" aria-controls="point5" aria-selected="false">
                                                                Content 5
                                                            </a>
                                                        </div>
                                                    </nav>
                                                    ...
                                                    <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                        ...
                                                        <div class="tab-pane fade" id="point3" role="tabpanel" aria-labelledby="custom-nav-contact-tab">
                                                          <div class="form-group">
                                                                <div class="row form-group">
                                                                    <div class="col-12 col-md-12">
                                                                        <textarea name="content3" id="content_area" rows="5" class="form-control"><?php echo $rwrecord['content3'];?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="tab-pane fade" id="point4" role="tabpanel" aria-labelledby="custom-nav-contact-tab">
                                                          <div class="form-group">
                                                                <div class="row form-group">
                                                                    <div class="col-12 col-md-12">
                                                                        <textarea name="content4" id="content_area" rows="5" class="form-control"><?php echo $rwrecord['content4'];?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>

                                                        <div class="tab-pane fade" id="point5" role="tabpanel" aria-labelledby="custom-nav-contact-tab">
                                                          <div class="form-group">
                                                                <div class="row form-group">
                                                                    <div class="col-12 col-md-12">
                                                                        <textarea name="content5" id="content_area" rows="5" class="form-control"><?php echo $rwrecord['content5'];?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
