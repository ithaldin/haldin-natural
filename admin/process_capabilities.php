<?php
    ...
    if ($_POST[Update])
    {
        $date=date("Y-m-d");
        $time=date("H:i:s");
   $qupdate = "UPDATE `t_technology` SET 
                        title = '".$_POST['title']."',
                        content = '".$_POST['content']."',
                        photo = '".$_POST['photo']."'
                        WHERE `t_technology`.`id` = 1";
    ...
    <!--<![endif]-->
        ...
        <body>
            ...
            <div id="right-panel" class="right-panel">
                ...
                <?php include "top_menu.php"?>
                 ...
                 <?php
                    $qrecord = "SELECT * FROM t_technology";
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">Update Process & Capabilities</strong>
                                    </div>
        ...
        <!---------------------------- ABOUT'S SETUP AREA ------------------------------->
           ...
           <!--------------------------------------- HAlDIN'S SETUP AREA ---------------------------------->
                 ...
                 <?php
                    $qrecord1 = "SELECT * FROM t_technology";
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <div class="tooltip-demo">
                                            <a href="edit_categories.php?id=<?php echo $rwrecord1['id']; ?>"><button type="button" class="btn btn-primary btn-xs"data-toggle="tooltip" data-placement="top" title="Edit/Hapus Kategori"><i class="fa fa-wrench"></i></button></a>
                                        </div>
                                        </td>
                                    </tr>
