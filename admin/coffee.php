                                                ...
                                                <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                    <div class="tab-pane fade show active" id="point1" role="tabpanel" aria-labelledby="custom-nav-home-tab">
                                                       <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="point1_content" type="text" id="content_area" rows="4" class="form-control" aria-required="true" aria-invalid="false"><?php echo $rwrecord['content_product1'];?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade" id="point2" role="tabpanel" aria-labelledby="custom-nav-profile-tab">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="point2_content" type="text" id="content_area" rows="4" class="form-control" aria-required="true" aria-invalid="false"><?php echo $rwrecord['content_product2'];?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade" id="point3" role="tabpanel" aria-labelledby="custom-nav-contact-tab">
                                                       <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="point3_content" type="text" id="content_area" rows="4" class="form-control" aria-required="true" aria-invalid="false"><?php echo $rwrecord['content_product3'];?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade" id="point4" role="tabpanel" aria-labelledby="custom-nav-contact-tab">
                                                       <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="point4_content" type="text" id="content_area" rows="4" class="form-control" aria-required="true" aria-invalid="false"><?php echo $rwrecord['content_product4'];?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
