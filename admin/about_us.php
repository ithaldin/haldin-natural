<?php
    ...
    if ($_POST[Update])
    {
        ...
        $qupdate = "    UPDATE `t_about_us` SET 
                        ...
                        aboutus_photo = '".$_POST['aboutus_photo']."'
        ...
        <!---------------------------- ABOUT'S SETUP AREA ------------------------------->
           ...
           <!--------------------------------------- HAlDIN'S SETUP AREA ---------------------------------->
                                                    ...
                                                    <nav>
                                                        <div class="nav nav-pills nav-justified mb-3" id="pills-tab" role="tablist">
                                                            <a class="nav-item nav-link active" id="custom-nav-home-tab" data-toggle="tab" href="#point1" role="tab" aria-controls="point1" aria-selected="true">
                                                                <h7 class="text-center"><?php echo $rwrecord['title1'];?></h7>
                                                            </a>
                                                            ...
                                                            <a class="nav-item nav-link" id="custom-nav-profile-tab" data-toggle="tab" href="#point2" role="tab" aria-controls="point2" aria-selected="false">
                                                              <h7 class="text-center"><?php echo $rwrecord['title2'];?></h7>
                                                            </a>
                                                        </div>
                                                    </nav>
                        ...
                        <!--------------------------------------- VIDEO AND PHOTO SETUP AREA ---------------------------------->
                                                    ...
                                                    <nav>
                                                        <div class="nav nav-pills nav-justified mb-3" id="pills-tab" role="tablist">
                                                            <a class="nav-item nav-link active" id="custom-nav-home-tab" data-toggle="tab" href="#point3" role="tab" aria-controls="point3" aria-selected="true">
                                                                VIDEOS
                                                            </a>

                                                            <a class="nav-item nav-link" id="custom-nav-profile-tab" data-toggle="tab" href="#point4" role="tab" aria-controls="point4" aria-selected="false">
                                                                PHOTOS
                                                            </a>
                                                        </div>
                                                    </nav>
                                                    ...
                                                    <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row form-group">
                                                                    <div class="col-12 col-md-12">
                                                                        ...
                                                                        <textarea name="aboutus_video" id="content_area" rows="5" class="form-control"><?php echo $rwrecord['aboutus_video'];?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="tab-pane fade" id="point4" role="tabpanel" aria-labelledby="custom-nav-profile-tab">
                                                            <div class="form-group">
                                                                <div class="row form-group">
                                                                    <div class="col-12 col-md-12">
                                                                        <textarea name="aboutus_photo" id="content_area" rows="5" class="form-control"><?php echo $rwrecord['aboutus_photo'];?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
