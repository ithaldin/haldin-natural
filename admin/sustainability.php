<?php
    ...
    if ($_POST[Update])
    {
        ...
        $qupdate = "    UPDATE `t_sustainability` SET 
                        ...
                        sustainability_isi = '".$_POST['sustainability_isi']."'
                                                    ...
                                                    <nav>
                                                        <div class="nav nav-pills nav-justified mb-3" id="pills-tab" role="tablist">
                                                            ...
                                                            <a class="nav-item nav-link" id="custom-nav-profile-tab" data-toggle="tab" href="#point2" role="tab" aria-controls="point2" aria-selected="false">
                                                              <h7 class="text-center">Our Approach to Sustainability</h7>
                                                            </a>
                                                    ...
                                                    <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                        ...
                                                        <div class="tab-pane fade" id="point2" role="tabpanel" aria-labelledby="custom-nav-profile-tab">
                                                            <div class="form-group">
                                                                <div class="row form-group">
                                                                    <div class="col-12 col-md-12">
                                                                        <textarea name="sustainability_isi" id="content_area" rows="5" class="form-control"><?php echo $rwrecord['sustainability_isi'];?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
