                    ...
                    <div class="text-center wow fadeIn">
                        ...
                        <div class="why_choose_us col-md-12">
                            <div id="about-slider3" class="owl-carousel owl-theme">
                                <img class="img-responsive" src="./img/product/menu product/essential oil - 1.png" alt="">
                                <img class="img-responsive" src="./img/product/menu product/essential oil - 2.png" alt="">
                            </div>
                        </div></br>
