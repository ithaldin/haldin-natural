            ...
            <div class="row flex-v-center">
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 hidden-sm">
                    <div id="about-slider3" class="owl-carousel owl-theme">
                        <img class="img_product_tea" src="img/product/menu product/cocoa.png" alt="">
                        <img class="img_product_tea" src="img/product/menu product/cocoa_extract.png" alt="">
                        <img class="img_product_tea" src="img/product/menu product/cocoa2.png" alt="">
                    </div>
                </div>
            ...
            <div class="row flex-v-center">
               ...
               <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 hidden-sm">
                    <div id="about-slider2" class="owl-carousel owl-theme">
                        <img class="img_product_coffee" src="img/product/menu product/vanilla - 1.png" alt="">
                        <img class="img_product_coffee" src="img/product/menu product/vanilla - 2.png" alt="">
                        <img class="img_product_coffee" src="img/product/menu product/vanilla - 3.png" alt="">
                    </div>
                </div>
